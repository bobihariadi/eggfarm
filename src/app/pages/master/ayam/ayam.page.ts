...
import { FormayamPage } from './formayam/formayam.page';

@Component({
  selector: 'app-ayam',
  templateUrl: './ayam.page.html',
  styleUrls: ['./ayam.page.scss'],
})
export class AyamPage implements OnInit {
  ...
  async getData(event?) {
    ...
    let arrdata = {
      action: 'arraytable',
      select:
        'id, batch_no, jumlah, pembelian, usia_awal, date_format(tgl_datang, "%d-%m-%Y") tgl_datang ',
      table: 'm_ayam ',
      limit: '',
      order: 'order by id',
      where: '',
